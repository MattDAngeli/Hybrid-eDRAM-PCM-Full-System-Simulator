#include "mem/HybridController/eDRAM_Cache_Side/replacement_policies/eDRAM_cache_fa_lru.hh"

eDRAMCacheFALRU::eDRAMCacheFALRU(eDRAMCacheFALRUParams *params)
    : eDRAMCacheFAReplacementPolicy(params)
{
    DPRINTF(Gem5Hacking, "eDRAMCacheFALRU is initiated. \n");
}
...
eDRAMCacheFALRU*
eDRAMCacheFALRUParams::create()
{
    return new eDRAMCacheFALRU(this);
}
